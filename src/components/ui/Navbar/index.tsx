...
export default function NavBar() {
  return (
    <div className="w-full h-navbarHeight shadow-navbar px-[15px] pb-[6.5px] pt-[2.5px] flex lg:gap-5 gap-1 justify-center items-center fixed bottom-0 z-20 bg-[#F2F2F2]">
